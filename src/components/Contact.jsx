    ...
    <section id="contact" className="section contact" aria-label="Contact">
      <div className="container">
        ...
        <div className="contact-grid">
          ...
          {/* A native POST keeps FormSubmit's hosted CAPTCHA and confirmation
              flow intact. No credentials or email-sending code run here. */}
          <form
          ...
          >
            ...
            <p id="contact-delivery" className="contact-form-note">
              ...
              so I can reply. You&apos;ll complete a spam check on the next page
